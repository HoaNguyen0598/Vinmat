    ...
    return (
        <div className="header">
            ...
            <div className="header_right">
                <Beel className="bell" />
                <div className="user">
                    <img src="https://images.unsplash.com/photo-1618590067824-5ba32ca76ce9?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80" alt="user"/>
                </div>
            </div>
        </div>
    )
